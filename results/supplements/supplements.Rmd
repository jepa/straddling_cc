...
```{r rfmomap, eval = T, echo = T, echo=FALSE, fig.height = 3,fig.width=8, fig.pos= "h", fig.cap='(ref:rfmomap)', out.extra=''}
...
```{r changesearlyhigh, eval = T, echo = T, echo=FALSE, fig.height=4, fig.width=8, fig.pos= "H", fig.cap='(ref:changesearlyhigh)', out.extra=''}
...
```{r changesmid, eval = T, echo = T, echo=FALSE, fig.height=10, fig.width=10, fig.pos="H", fig.cap='(ref:changesmid)', out.extra=''}
...
```{r netchanges, eval = T, echo = T, echo=FALSE, fig.height=10, fig.width=10, fig.pos="H", fig.cap='(ref:netchanges)', out.extra=''}
...
```{r netchangesrfmo, eval = T, echo = T, echo=FALSE, fig.height=10, fig.width=10, fig.pos = "H", fig.cap="(ref:netchangesrfmo)", out.extra=''}
...
```{r treshold, eval = T, echo = T, echo=FALSE, fig.height = 5, fig.width = 9, fig.pos= "H", fig.align='center',fig.cap="(ref:treshold)"}
...
```{r ntransboundary, eval = T, echo = T, echo=FALSE, fig.height = 5, fig.width=9, fig.pos= "H", fig.cap="(ref:ntransboundary)", out.extra=''}
...
```{r tablestraddling, eval = T, echo = F, message = FALSE}
...
readr::read_csv(here::here('./results/supplements/straddling_species.csv')) %>% 
  ...
  kable("latex",
        caption = "\\textbf{List of straddling species identified in the present study grouped by “commercial group” based on the Sea Around Us classification.}",
        booktabs = TRUE,
        # col.names = NULL,
...
```{r tablerpackages, eval = T, echo = F, message = FALSE}
