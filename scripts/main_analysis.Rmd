...
suppressMessages(
  mclapply(run_me_list,
           ...
           hs_index = ob_index,
           high_mig = F,
           folder_name = "/lauren/per_change_realm_ob",
...
write_csv(prop_data,
          my_path("R", "uploaded", name = "proportion_change_data.csv")
)
...
data.frame(
  ...
  write_csv(.,
            my_path("R", "uploaded", name = "proportion_change_metadata.csv")
  )
...
write_csv(rfmo_prop_data,
          my_path("R", "uploaded", name = "hm_proportion_change_data.csv")
)
...
# Save plot 
ggsave("./results/figures/fig_1ac.png",
       map_high_seas_stradd,
       height = 7,
       width = 12
)
