...
main_fx(taxon_key = 600107,
        data = stradd_data,
        fao_area = "Pacific, Eastern Central")

main_fx <- function(taxon_key,data,fao_area){
